...
<body>
    ...
    <div class="HiringForm" align="center" id="body">
        <form  method="POST" action="dbHiring.php" enctype="multipart/form-data">
            <label>Full Name:<br><input name="name" type="text" id="fname" placeholder="your fullname..."><span style="font-family: serif">*</span></label><br>
            <label >Email:<br><input name="email" type="email" id="email" placeholder="enter email"><span style="font-family: serif">*</span></label><br>               
            <label>Upload Resume:<br><input name="pdf_file" type="file" id="myFile"><span style="font-family: serif">*</span></label>
            <br>
