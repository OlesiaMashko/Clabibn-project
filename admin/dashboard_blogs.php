...
<body>
  ...
  <section class="home-section">
    <br>
    <div class="box">
      <form method="POST" action="db_dashboard_blogs.php" enctype="multipart/form-data">
      <div class="r">
        <div class="col-25">
          <label for="name">Blog Name</label>
        </div>
        <div class="col-75">
          <input type="text" id="name" name="blogname" placeholder="Blog name..">
        </div>
      </div>
      <div class="r">
        <div class="col-25">
          <label for="name">Blog's Subheader</label>
        </div>
        <div class="col-75">
          <input type="text" id="name" name="subheader" placeholder="Blog's Subheader..">
        </div>
      </div>
      <div class="r">
        <div class="col-25">
      ...
      <div class="r">
        ...
        <div class="col-75">
          <input type="datetime-local" id="name" name="date" >
        </div>
      </div>
      <div class="r">
        <div class="col-25">
          <label for="name">Blog's Author</label>
        </div>
        <div class="col-75">
          <input type="text" id="name" name="author" placeholder="Blog's Author..">
        </div>
      </div>
      <div class="r">
        <div class="col-25">
          <label for="subject">Blog</label>
        </div>
        <div class="col-75">
          <textarea id="blog" name="blog" placeholder="Write something.." style="height:200px"></textarea>
        </div>
